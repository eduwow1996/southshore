...
<html>
    <head>
        ...
        <link rel="stylesheet" href="payment-assets/css/airdatepicker.min.css">
    </head>
	<body>
		<div>
            <div id="coverpage">
			...
			<form id="paymentform" class="" action="" method="post">
			    ...
			    <fieldset>
    				...
    				<div class="col-sm-12">
                        ...
                        <?php if(empty($payments)): ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Package_Id">
                                            ...
                                            <?php foreach($packages as $key => $value): ?>
                                                <option value="<?php echo $value['package_id']; ?>:<?php echo $value['package_name']; ?>"><?php echo $value['package_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group" id="details_package">
                                        <h3 style="font-weight:bold;">Terms and Conditions</h3>
                                        <p><b>HOW TO RESERVE:</b> Once you have decided to begin your adventure with us, please do not hesitate to make a reservation by filling up the form in this page and check out.</p>
                                        <p><b>PAYMENT TERMS:</b> We require at least 50% down payment in order to officially reserve your booking. We accept various payment methods such as the following: 1. Debit or Credit Card – Mastercard, Visa, JCB, Diners, AmEx and others through Paypal Business account (with 5% transfer fee) 2. PayPal 3. Bank deposit – Local banks such as BDO, BPI and others 4. Wire Transfer – Western, Palawan, Cebuana, Mlhullier, MoneyGram When your payment has been made, please send a copy of the payment receipt to southshoretour@gmail.com or southshoretoursph@gmail.com After receiving the down payment, We will email your travel voucher and receipt for the booking confirmation. The 50% balance can be paid on the day of the tour.</p>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group" id="details_package_itinerary">
                                        <p><b>BOOKING POLICY:</b>Please note that if a booking is made less than 3 days prior to tour date, full payment must be paid at once. We accommodate last minute bookings which should still be at least 1 day before tour date. Full payment is required. We follow a strictly No Show No Refund policy.</p>
                                        <p><b>CANCELLATION POLICY BAD WEATHER/TYPHOON:</b> 90% is refundable of the total amount of the reservations and 10% admin is fee. CHANGE OF MIND/BACK OUT: NON REFUNDABLE NO SHOW. NO REFUND.</p>
                                        <p><b>INFORMATION</b> For further questions, you may reach us through: WhatsApp/Viber:+639776468620 Globe: +639776468620/ 09675394470 Cebu Landline: (032) 4132942 / 2660473</p>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group" id="details_package_per_head">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row" id="next_step_one" style="display:none;">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        <label>Total Number of Person</label>
                                        <input type="text" class="form-control" name="number_of_people" placeholder="Number of people"/>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3" style="display:none;" id="excess_payment">
                                    <div class="form-group">
                                        <label>Total Number of Filipinos</label>
                                        <input type="text" class="form-control" name="Number_Of_Filipinos" disabled placeholder="Number of Filipinos" value="0"/>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Payment_Type">
                                            <option selected hidden value="0">Select Payment Type</option>
    						...
    						<div class="form-row">
    							<div class="col-md-6 mb-3">
    								<label for="Amount">Amount (Paypal Transaction Fee Included (5%))</label>
    							...
    							<?php if(!DONATION): ?>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="Payment_For" class="form-control form-control-lg required" id="Payment_For" placeholder="Enter payment details" aria-describedby="Payment_ForPrepend" readonly>
                                            <div class="invalid-tooltip">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="First_Name">Lead Guest's Name:</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="Pickup_Address">Hotel or Pick up Address</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id=""><i class="fas fa-map"></i></span>
                                    </div>
                                    <input type="text" name="Hotel_Pickup_Address" class="form-control form-control-lg required" id="Pickup_Address" placeholder="Pick up address">
                                    <div class="invalid-tooltip">
                        ...
                        <div class="form-row">
                            <div class="col-md-5 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="Tour_Date" class="form-control form-control-lg required" id="Tour_Date" placeholder="Tour Date">
                                    <div class="invalid-tooltip">
                                        Please enter your pick up address
                                    </div>
                                </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="Additional_Information">Special Request (optional)</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id=""><i class="fas fa-sticky-note"></i></span>
                                    </div>
                                    <textarea name="Special_Request" class="form-control form-control-lg" id="Special_Request" placeholder="Special Request" rows="3"></textarea>
                                    <div class="invalid-tooltip">
                                    </div>
                                </div>
                            </div>
    ...
    <?php endif; ?>
		...
		<script src="payment-assets/js/airdatepicker.min.js"></script>
		<script src="payment-assets/js/airdatepicker_en.js"></script>
    <?php if ($gateways['stripe']): ?>
    ...
    <?php endif; ?>
		<script type="text/javascript">
			$(document).ready(function(){
                ...
                var price = 0;
                var total_payment = 0;
                var total_payment2 = 0;

                var additional = 500;
                var type_s = '';
                $(document).on('change','select[name="Package_Id"]',function(){
                    var id = $(this).val().split(":")[0];
                    $('input[name="Payment_For"]').val($(this).val().split(":")[1]);
                    $.ajax({
                        url:"<?php (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>parser.php",
                        type:'post',
                        data:{
                            'get_details':1,
                            'package_id':id
                            ...
                            var str_itinerary = '';
                            var str_sub = '';
                            type_s = obj.package.excess_payment;
                            if(obj.package.excess_payment == '1'){
                                $("#excess_payment").show();
                                $('input[name="Number_Of_Filipinos"]').attr('disabled',false);
                            } else {
                                $("#excess_payment").hide();
                                $('input[name="Number_Of_Filipinos"]').attr('disabled',true);
                            }

                            str_sub += '<div><b>Prices:</b></div>';
                            $.each(obj.package_sub,function(a,b){
                                str_sub += '<div>PHP'+b.price+' per head minimum of '+b.per_person+' person</div>';
                            });
                            if(obj.package.excess_payment == '1'){
                                str_sub += '<p><b>Plus 500 on each foreigner<b></p>';
                            }
                            $("#details_package_per_head").html(str_sub);
                            $("#next_step_one").show();
                            $("#Amount").val(0);
                            $('select[name="Payment_Type"]').val(0);
                            $('input[name="Number_Of_Filipinos"]').val(0);
                            $('input[name="number_of_people"]').val(0);
                        }
                    });
                });

                $(document).on('change','input[name="number_of_people"]',function(){
                    var id = $('select[name="Package_Id"]').val().split(":")[0];
                    ...
                    $.ajax({
                        ...
                        async:false,
                        data:{
                            'get_details_price_per_person':1,
                            'number_of_person':number_of_person,
                            'package_id':id,
                        },success:function(data){
                            var obj = $.parseJSON(data);
                            var price2 = parseFloat(obj.package_sub.price.replace(",",""));
                            total_payment2 = price2 * parseInt(number_of_person);
                        }
                    });
                });
                $(document).on('change','select[name="Payment_Type"]',function(){
                    ...
                    var total_add = 0;
                     var payment = 0;
                    var number_of_people = parseInt($('input[name="number_of_people"]').val());
                    var total_filipino = parseInt($('input[name="Number_Of_Filipinos"]').val());
                    if(type_s == '1'){
                        if(total_filipino > 0){
                            total_add = (number_of_people - total_filipino) * additional;
                        } else {
                            total_add = number_of_people * additional;
                        }
                    }
                    if(type == '1'){
                        payment = (total_payment2 + total_add) / 2;
                    } else{
                        payment = total_payment2 + total_add;
                    }
                    var paypal_fee = payment * 0.05;

                    $("#Amount").val(payment + paypal_fee).trigger('change');
                });
                $(document).on('change','input[name="Number_Of_Filipinos"]',function(){

                    // $("#Amount").val(payment).trigger('change');
                });
                var amount = 0;
                ...
                function showsuccess(trans){
                    $('#coverpage').html('<div class="successpage col-md-12 text-center"><div class="mt-4"><i class="fas fa-check-circle fa-9x text-success" ></i><h2>Your transaction with the amount of ₱'+amount+' was completed successfully</h2><h3 class="mb-5">Transaction ID: <b>'+trans+'</b></h3><p><a href="" class="btn btn-primary btn-lg">Go Back</a></p></div></div>');
                    $('#coverpage').fadeIn();
                }
